module.exports = class UsuariosDAO {
    ...
    inserindoUsuarios(adicionandoUsuario){
        return new Promise((resolve,reject)=>{
            this.db.all("INSERT INTO USUARIOS (NOME, EMAIL, SENHA) VALUES (?, ?, ?)", adicionandoUsuario, (error)=>{
    ...
    deletandoUsuarios(deletaUsuario){
        return new Promise((resolve, reject)=>{
            this.db.all("DELETE FROM USUARIOS WHERE ID = ?", deletaUsuario, (error)=>{
    ...
    atualizandoUsuario(atualizarUsuario){
        return new Promise((resolve, reject)=>{
            this.db.all("UPDATE USUARIOS SET NOME = ?, EMAIL = ?, SENHA = ? WHERE ID = ?", atualizarUsuario, (error)=>{
